...
иностранца. Вы ему что-то говорите, а он в зависимости от того как понял отвечает вам.
...
Помните пример из введения про гости у иностранца. Так вот находясь в гостях, трогать вы ничего не можете.
JS работает в среде браузера. Вы как бы приходите в гости в операционную систему пользователя, но не можете выйти за пределы браузера
(из за соображений безопасности). Это состояние называется песочницей.
...
##Новшества и кроссбраузерность

Мы будем рассматривать только последние версии браузеров.
Но когда будем обсуждать предстоящие нововведения, я буду акцентировать на этом внимание.

## Требования

Я подразумеваю, что ты уже знаешь циклы и условия и мы будем изучать только особенности языка.
```
for(;;)
```
```
...
3. Ищем вкладку "консоль".Открываем.
